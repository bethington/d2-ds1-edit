...
| [Monsters and objects](guides/monsters-and-objects.md) | Siramy tutorial, 2010 | 61 claims, no sampling; D2Common 1.09d + 1.13c; re-verified against vanilla tables with zero discrepancies | 7 items: attribution (TeknoKyo/SVR, the 1.10s beta), 2 untested live-game behaviours, an untraced 1.09 index band, an unexplained object-name permutation |
