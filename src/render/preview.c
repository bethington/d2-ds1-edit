/* Derived from win_ds1edit by Paul Siramy (originally wPreview.c).
...
void wpreview_init_palette_state(int ds1_idx)
{
   ...
   {
      wpreview_old_pal = palette_resolve_index(glb_ds1[ds1_idx].txt_act,
                                               glb_ds1[ds1_idx].act);
   }
   else
...
void wpreview_draw_tiles(int ds1_idx)
{
   ...
   if (glb_ds1edit.cmd_line.force_pal_num == -1)
   {
      int cur_pal = palette_resolve_index(glb_ds1[ds1_idx].txt_act,
                                          glb_ds1[ds1_idx].act);
      if (wpreview_old_pal != cur_pal)
      {
         wpreview_old_pal = cur_pal;
